...
export function isValidThinkingBar(val: unknown): val is QuizThinkingBarStyleId {
  return (
    typeof val === "string" &&
    val !== "auto" &&
    (ALL_THINKING_BAR_STYLES.includes(val) || /^[a-z][a-z0-9-]*\.thinking-bar\.[a-z][a-z0-9-]*$/.test(val))
  );
}
...
export function isValidQuestionBox(val: unknown): val is QuizQuestionBoxStyleId {
  return (
    typeof val === "string" &&
    val !== "auto" &&
    (ALL_QUESTION_BOX_STYLES.includes(val) || /^[a-z][a-z0-9-]*\.question-box\.[a-z][a-z0-9-]*$/.test(val))
  );
}
...
export function isValidAnswerCard(val: unknown): val is QuizAnswerCardStyleId {
  return (
    typeof val === "string" &&
    val !== "auto" &&
    (ALL_ANSWER_CARD_STYLES.includes(val) || /^[a-z][a-z0-9-]*\.answer-card\.[a-z][a-z0-9-]*$/.test(val))
  );
}
...
export function isValidCounter(val: unknown): val is QuizQuestionCounterStyleId {
  return (
    typeof val === "string" &&
    val !== "auto" &&
    (ALL_QUESTION_COUNTER_STYLES.includes(val) || /^[a-z][a-z0-9-]*\.counter\.[a-z][a-z0-9-]*$/.test(val))
  );
}
...
export function isValidBackground(val: unknown): val is QuizBackgroundStyleId {
  return (
    typeof val === "string" &&
    val !== "auto" &&
    (ALL_BACKGROUND_STYLES.includes(val) || /^[a-z][a-z0-9-]*\.background\.[a-z][a-z0-9-]*$/.test(val))
  );
}
