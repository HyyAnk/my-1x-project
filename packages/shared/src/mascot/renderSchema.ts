...
import { MascotPublishedAnimationAssetSchema } from "./animation/animationSchema.js";

export { MascotAssetRegistrationSchema, MascotBoundsSchema, MascotCanvasSizeSchema, MascotPointSchema };

/**
 * @deprecated Legacy V1 multi-frame animation schema. Use `MascotPublishedAnimationAssetSchema` instead.
 */
