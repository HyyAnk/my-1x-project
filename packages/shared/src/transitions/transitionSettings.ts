import type { ResolvedTransitionSettings, TransitionPlacement, TransitionSelection, TransitionSettingSources } from "./transition.types.js";
...
function resolvePlacementSelection(placement: TransitionPlacement, sources: TransitionSettingSources): TransitionSelection {
 ...
 */
export function fromLegacyIntroTransition(transitionType?: string, transitionDurationSeconds?: number): TransitionSelection | undefined {
