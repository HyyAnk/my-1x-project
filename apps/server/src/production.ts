...
export function assessProduction(input: {
  ...
  if (scenes.length === 0)
    add("scene_plan", "blocker", "No production shots exist.", "Generate the shot breakdown after the visual bible is ready.", 25);
  if (scenes.length > 0 && sequenceCount < 5)
    add(
      "sequence_count",
      "warning",
  ...
  if (scenes.length > 0 && structuredPromptRatio < 0.95)
    add(
      "prompt_structure",
      "warning",
  ...
  if (scenes.length > 0 && continuityCoverageRatio < 0.95)
    add(
      "continuity_coverage",
      "blocker",
  ...
  if (scenes.length > 0 && sourceCoverageRatio < 0.75)
    add(
      "source_coverage",
      "warning",
  ...
  if (scenes.length > 0 && narrationCoverageRatio < 0.975)
    add(
      "narration_coverage",
      "blocker",
  ...
  if (scenes.length && (overlayCoverageRatio < 0.2 || overlayCoverageRatio > 0.35))
    add(
      "overlay_coverage",
      "warning",
