...
import { exportStyleModulePackage, importStyleModulePackage } from "../quiz/visual/styleModules/exportPackage.js";
...
export function registerStyleModulesRoutes(): FastifyPluginCallback {
