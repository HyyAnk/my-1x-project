...
.choice-tier-long .answer-card span {
  font-size: var(--choice-fitted-font-size, var(--choice-font-size-long, 32px));
}
...
.choice-tier-overflow .answer-card span {
  font-size: var(--choice-fitted-font-size, var(--choice-font-size-very_long, 26px));
}

/* Visual Choice Card Typography */
.choice-card-visual .choice-text,
.visual-answer-label span {
  font-size: var(--choice-fitted-font-size, var(--choice-label-font-size-base, 32px));
}
...
.choice-tier-medium.visual-answer-card .visual-answer-label span {
  font-size: var(--choice-fitted-font-size, var(--choice-label-font-size-medium, 28px));
}
...
.choice-tier-long.visual-answer-card .visual-answer-label span {
  font-size: var(--choice-fitted-font-size, var(--choice-label-font-size-long, 24px));
}
...
.choice-tier-overflow.visual-answer-card .visual-answer-label span {
  font-size: var(--choice-fitted-font-size, var(--choice-label-font-size-very_long, 24px));
}
`;
}
