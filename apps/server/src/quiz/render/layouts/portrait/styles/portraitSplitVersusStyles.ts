...
/**
 * Returns the CSS styles for the Portrait Split Versus layout (9:16 Vertical Video).
 */
export function getPortraitSplitVersusCss(_aspectRatio?: MascotRenderAspectRatio): string {
  return `
