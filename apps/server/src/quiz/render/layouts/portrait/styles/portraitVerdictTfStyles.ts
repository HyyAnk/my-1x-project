...
/**
 * Returns the CSS styles for the Portrait Verdict True/False layout (9:16 Vertical Video).
 */
export function getPortraitVerdictTfCss(_aspectRatio?: MascotRenderAspectRatio): string {
  return `
