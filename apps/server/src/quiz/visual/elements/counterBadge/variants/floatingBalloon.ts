...
export const floatingBalloonVariant: CounterBadgeVariant = {
  ...
  renderHtml(input: CounterBadgeRenderInput): string {
    return `<div class="cb-floating-balloon" data-counter-badge data-layout-allow-occlusion><div class="balloon-streamers" aria-hidden="true"><span class="balloon-streamer streamer-left"></span><div class="balloon-top-knot"><span class="knot-bow">✦</span></div><span class="balloon-streamer streamer-right"></span></div><div class="balloon-plaque" data-counter-badge-body><div class="balloon-gloss-shine" data-layout-ignore aria-hidden="true"></div><div class="balloon-inner-panel"><span class="question-number-val balloon-num">${input.questionNumber}</span></div><span class="balloon-sparkle sparkle-tl" data-layout-ignore aria-hidden="true">✦</span><span class="balloon-sparkle sparkle-br" data-layout-ignore aria-hidden="true">★</span><div class="balloon-bottom-tie" data-layout-ignore aria-hidden="true"><span class="balloon-tail-knot"></span><span class="balloon-curled-ribbon"></span></div></div></div>`;
  },
  renderCss(): string {
    return `
.cb-floating-balloon { --counter-badge-mount-height: 64px; --counter-badge-body-height: 150px; position: relative; z-index: 6; display: flex; flex-direction: column; align-items: center; width: 240px; transform-origin: 50% 0; animation: balloon-bounce-enter .68s cubic-bezier(.18,1.42,.34,1) var(--clip-start, 0s) both, balloon-bob-float 3.6s ease-in-out calc(var(--clip-start, 0s) + .68s) infinite alternate both; contain: layout style; will-change: transform; }
.cb-floating-balloon .balloon-streamers { position: relative; display: flex; justify-content: space-between; align-items: flex-start; width: 160px; height: 64px; pointer-events: none; }
.cb-floating-balloon .balloon-streamer { width: 8px; height: calc(100% + 8px); margin-top: -8px; border-radius: 4px; background: repeating-linear-gradient(135deg, #FF6B8B 0px, #FF6B8B 6px, #FFD166 6px, #FFD166 12px); box-shadow: 0 2px 6px rgba(13,35,71,.25); }
