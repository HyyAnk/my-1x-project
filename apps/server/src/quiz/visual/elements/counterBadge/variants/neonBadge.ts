...
export const neonBadgeVariant: CounterBadgeVariant = {
  ...
  renderHtml(input: CounterBadgeRenderInput): string {
    return `<div class="cb-neon-badge" data-counter-badge data-layout-allow-occlusion><div class="neon-mount" aria-hidden="true"><span class="neon-pylon pylon-left"></span><div class="neon-mount-bar"></div><span class="neon-pylon pylon-right"></span></div><div class="neon-badge-plaque" data-counter-badge-body><span class="neon-reticle reticle-tl" data-layout-ignore aria-hidden="true">⌜</span><span class="neon-reticle reticle-br" data-layout-ignore aria-hidden="true">⌟</span><div class="neon-inner-screen"><span class="question-number-val neon-num">${input.questionNumber}</span></div><span class="neon-spark spark-tr" data-layout-ignore aria-hidden="true">⚡</span><span class="neon-spark spark-bl" data-layout-ignore aria-hidden="true">✦</span></div></div>`;
  },
  renderCss(): string {
    return `
.cb-neon-badge { --counter-badge-mount-height: 64px; --counter-badge-body-height: 150px; position: relative; z-index: 6; display: flex; flex-direction: column; align-items: center; width: 240px; transform-origin: 50% 0; animation: cyber-neon-enter .64s cubic-bezier(.18,1.42,.34,1) var(--clip-start, 0s) both, cyber-neon-float 3.8s ease-in-out calc(var(--clip-start, 0s) + .64s) infinite alternate both; }
.cb-neon-badge .neon-mount { position: relative; display: flex; justify-content: space-between; align-items: flex-start; width: 160px; height: 64px; pointer-events: none; }
.cb-neon-badge .neon-pylon { width: 8px; height: calc(100% + 8px); margin-top: -8px; border-radius: 4px; background: linear-gradient(180deg, #00F0FF 0%, #152438 45%, #00F0FF 100%); box-shadow: 0 0 8px rgba(0,240,255,0.6); }
