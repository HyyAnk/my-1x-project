...
.cb-golden-shield .shield-outer { position: relative; width: 94px; height: 106px; border-radius: 14px 14px 44px 44px; border: 4px solid #FFF099; background: linear-gradient(135deg, #FFF099 0%, #F5B000 45%, #8C5900 100%); padding: 5px; display: grid; place-items: center; box-shadow: 0 8px 16px rgba(0,0,0,0.3); }
.cb-golden-shield .shield-glint { position: absolute; inset: 0; border-radius: 10px 10px 40px 40px; background: linear-gradient(115deg, transparent 40%, rgba(255,255,255,0.7) 50%, transparent 60%); pointer-events: none; animation: shieldShine 3.5s ease-in-out infinite; }
.cb-golden-shield .shield-inner { width: 80px; height: 92px; border-radius: 10px 10px 38px 38px; border: 2px solid #F5B000; background: linear-gradient(180deg, #2E1B00 0%, #5E3900 100%); display: flex; flex-direction: column; align-items: center; justify-content: center; }
