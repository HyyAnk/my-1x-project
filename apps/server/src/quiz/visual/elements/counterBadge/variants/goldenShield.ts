...
export const goldenShieldVariant: CounterBadgeVariant = {
  ...
  renderHtml(input: CounterBadgeRenderInput): string {
    return `<div class="cb-golden-shield" data-counter-badge data-layout-allow-occlusion><div class="shield-chains" aria-hidden="true"><span class="shield-chain chain-left"></span><div class="shield-top-crest"><span>👑</span></div><span class="shield-chain chain-right"></span></div><div class="shield-plaque" data-counter-badge-body><span class="shield-bracket bracket-left" aria-hidden="true"><i class="bracket-gem"></i></span><span class="shield-bracket bracket-right" aria-hidden="true"><i class="bracket-gem"></i></span><div class="shield-inner-panel"><span class="question-number-val shield-num">${input.questionNumber}</span></div><span class="shield-star star-tl" data-layout-ignore aria-hidden="true">✦</span><span class="shield-star star-br" data-layout-ignore aria-hidden="true">★</span></div></div>`;
  },
  renderCss(): string {
    return `
.cb-golden-shield { --counter-badge-mount-height: 64px; --counter-badge-body-height: 150px; position: relative; z-index: 6; display: flex; flex-direction: column; align-items: center; width: 240px; transform-origin: 50% 0; animation: shield-drop-enter .64s cubic-bezier(.18,1.42,.34,1) var(--clip-start, 0s) both, shield-float 4.0s ease-in-out calc(var(--clip-start, 0s) + .64s) infinite alternate both; contain: layout style; will-change: transform; }
.cb-golden-shield .shield-chains { position: relative; display: flex; justify-content: space-between; align-items: flex-start; width: 160px; height: 64px; pointer-events: none; }
.cb-golden-shield .shield-chain { width: 9px; height: calc(100% + 8px); margin-top: -8px; border-radius: 4px; background: repeating-linear-gradient(180deg, #FFE066 0px, #FFE066 5px, #B37400 5px, #B37400 10px); box-shadow: 0 2px 5px rgba(13,35,71,.28), inset 0 0 2px #FFF; }
