...
.qb-parchment-scroll .scroll-body { position: relative; flex: 1; height: 100%; min-height: 168px; display: flex; align-items: center; justify-content: center; padding: 18px 36px; box-sizing: border-box; background: #F6E6C2; border-top: 5px solid #8C572A; border-bottom: 5px solid #8C572A; box-shadow: 0 14px 28px rgba(0,0,0,0.25); }
