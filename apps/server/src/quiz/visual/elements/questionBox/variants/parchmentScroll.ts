...
export const parchmentScrollVariant: QuestionBoxVariant = {
  ...
  renderCss(): string {
    return `
.qb-parchment-scroll .scroll-wrap { position: relative; width: 100%; display: flex; align-items: center; justify-content: center; }
.qb-parchment-scroll .scroll-body { position: relative; flex: 1; padding: 26px 36px; background: #F6E6C2; border-top: 5px solid #8C572A; border-bottom: 5px solid #8C572A; box-shadow: 0 14px 28px rgba(0,0,0,0.25); }
