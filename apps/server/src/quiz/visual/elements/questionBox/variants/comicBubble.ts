...
export const comicBubbleVariant: QuestionBoxVariant = {
  ...
  renderCss(): string {
    return `
.qb-comic-bubble .comic-bubble-body { position: relative; width: 100%; height: 100%; min-height: 168px; display: flex; align-items: center; justify-content: center; padding: 16px 44px; box-sizing: border-box; border: 8px solid #132A58; border-radius: 40px; background: #FFFEEA; box-shadow: 12px 14px 0 #132A58, 0 20px 30px rgba(0,0,0,.15); overflow: visible; }
