/**
 * 5x7 Basic ASCII bitmap font definitions for characters 32-126.
 * Each character is represented by 5 column byte masks (7 bits each).
 */

export type BitmapFont = Record<string, number[]>;
