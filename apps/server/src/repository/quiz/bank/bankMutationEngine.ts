...
import { getBankSqliteDb, withBankSqliteDb, closeBankSqliteDb } from "./bankSqliteEngine.js";
import { upsertBankQuestionSqlite, deleteBankQuestionSqlite, clearBankQuestionsSqlite } from "./bankSqliteMutations.js";
...
export async function saveQuestionBankQuestionUnlocked(this: RepositoryRuntime, question: BankQuestion): Promise<BankQuestion> {
  ...
  return withBankSqliteDb(runtimeBankRoot, async (db) => {
    ...
    try {
      ...
      cache.onQuestionSaved(toSave, prevMeta ? {
