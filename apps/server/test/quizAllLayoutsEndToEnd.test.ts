...
describe("Quiz All 6 Layouts End-to-End Integration", () => {
  ...
  describe("4. Sandbox Preview Composition for All Layouts", () => {
    ...
    for (const sc of sandboxCases) {
      const ar = sc.aspect_ratio ?? "16:9";
      it(`builds valid sandbox preview for ${sc.layoutId} (${ar}) across all phases`, () => {
