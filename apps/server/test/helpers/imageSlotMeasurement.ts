 ...
 */
export async function measureLayoutImageSlots(page: Page, options: MeasureLayoutSlotsOptions): Promise<MeasuredImageSlot[]> {
  ...
  return rawSlots.map((slot) => ({
    ...
    currentPlannedRatio: slot.role === "hero_question_image" ? currentPlannedHeroRatio : currentPlannedChoiceRatio,
  }));
}
