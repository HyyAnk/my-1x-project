...
export const api = {
  ...
  removeMascotBackground: (id: string, target: RemoveMascotBackgroundInput["target"] = "all") => request<{ mascot: MascotProfile }>(`/api/mascots/${id}/remove-background`, { method: "POST", body: JSON.stringify({ target }) }),
