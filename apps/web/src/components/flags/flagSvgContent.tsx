...
const GLOBAL_FLAG: React.ReactNode = (
  <g>
...
const FLAG_SVG_MAP: Record<string, React.ReactNode> = {
  VN: (
    <g>
...
export function getFlagSvgContent(code: string): React.ReactNode {
  return FLAG_SVG_MAP[code] ?? GLOBAL_FLAG;
}
