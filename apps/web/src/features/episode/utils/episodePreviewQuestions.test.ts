  ...
  questions: [
    {
      ...
      correct_choice_id: "a",
      explanation: "Tigers have distinctive dark stripes.",
      fun_fact: "Each tiger has a unique pattern of stripes.",
      source_ids: ["source-1"],
      visual_opportunity: "Illustration of a tiger",
  ...
  it("uses the question's director layout and real content", () => {
    ...
    expect(buildEpisodePreviewQuestions(quiz, director)).toEqual([
      expect.objectContaining({
        ...
        choices: ["Tiger", "Elephant", "Dolphin"],
