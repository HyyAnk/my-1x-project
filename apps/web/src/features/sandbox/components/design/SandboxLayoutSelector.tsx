...
export function SandboxLayoutSelector({ layoutId, setLayoutId, disabled = false, aspectRatio = "16:9" }: SandboxLayoutSelectorProps) {
  ...
  const { isOpen, containerRef, labelId, handleSelect, triggerProps, listboxProps } = useAccessibleDropdown<QuizLayoutUiDefinition>({
  ...
  return (
    <div ref={containerRef} style={{ position: "relative", width: "100%" }}>
      ...
      <div style={{ marginTop: "4px", fontSize: "11px", color: "var(--muted)", lineHeight: 1.3 }}>{t(selectedLayout.descriptionKey)}</div>
