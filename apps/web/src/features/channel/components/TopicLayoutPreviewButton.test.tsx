...
describe("TopicLayoutPreviewButton", () => {
  ...
  it("renders default Deep Trivia layout badge and popover wireframe", () => {
    const { getByRole, getByText } = render(<TopicLayoutPreviewButton quizFormat="multiple_choice" />);
  ...
  it("resolves Speed Blitz / full_stack_list when archetype is speed_blitz", () => {
    const { getByRole, getByText } = render(<TopicLayoutPreviewButton quizFormat="multiple_choice" archetype="speed_blitz" />);
  ...
  it("resolves Visual Spotting / visual_choices_three_pure when archetype is visual_spotting", () => {
    const { getByRole, getByText } = render(<TopicLayoutPreviewButton quizFormat="odd_one_out" archetype="visual_spotting" />);
