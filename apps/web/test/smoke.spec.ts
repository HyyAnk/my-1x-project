...
test("channel creation requires a concise channel name", async ({ page }) => {
  await page.goto("/");
  await page
...
test("channel library exposes channels and the primary create action", async ({ page }) => {
  const quiz = {
...
test("confirmed episode runs script to scene to render without F5", async ({ page }) => {
  const channel = {
