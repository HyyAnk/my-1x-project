...
if (process.argv[1] && process.argv[1].endsWith('validateGlobalBrands.js')) {
  const targetPath = process.argv[2] || path.join(process.cwd(), '.quiz-studio', 'knowledge_base', 'entities', 'global_brands.json');
