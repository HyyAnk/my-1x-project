...
if __name__ == '__main__':
    imgs = get_album_images("/sarah-connor-wallpapers", 8)
    print(f"Found {len(imgs)} candidate images for Sarah Connor")
    for i, u in enumerate(imgs):
        out = f"tmp/inspect_candidates/sarah_connor_{i+1}.png"
